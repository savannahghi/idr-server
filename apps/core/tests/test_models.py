...
from apps.sql_data.models import SQLDatabaseSource, SQLExtractMetadata
...
class TestAbstractExtractMetadata(TestCase):
    ...
    def test_default_class_str(self):
        assert str(self.sql_extract_metadata) == str(self.sql_extract_metadata.name)
